...
export const TermstemList: TermsItem[] = [
    ...
    content: (
      <>
        <p className="font-light mb-4">
          (Last Reviewed on January 01, 2016) Welcome to the Hoffman website,
          (the “Site”). The Site is a copyrighted work belonging to Hoffman,
          Inc., a Delaware corporation (“Hoffman”). Hoffman grants you the right
          to use the Site and the features, content or applications offered in
          connection with the Site subject to the terms and conditions (“Terms”)
          set forth below.
        </p>
      </>
    ),
    ...
    content: (
      <>
        ...
        <p className="font-light mb-4">
          ...
          Terms, and the terms set forth in Hoffman’s Privacy Policy, the terms
          of which are incorporated into, and considered part of, this
          Agreement. Hoffman’s Privacy Policy can be found at
          www.Hoffman.com/privacypolicy.
        </p>
        <p className="font-light mb-4">
          ...
          comply with and to be bound by these Terms as changed. Hoffman
...

  {
    ...
    content: (
      <>
        <p className="font-light mb-4">
          Subject to the Terms, Hoffman grants you a non-transferable,
          ...
          or potential investor in Hoffman, and not to compete with Hoffman.
        </p>
      </>
    ),
  },
    ...
    content: (
      <>
        <p className="font-light mb-4">
          ...
          any activity, unlawful or otherwise, that infringes Hoffman’s rights
  ...
  {
    title: 'Hoffman SERVICES SOFTWARE',
    content: (
      <>
        <p className="font-light mb-4">
          If you use, access or download any of Hoffman’s software or services,
          you will be subject to the terms of Hoffman’s End User Terms of Use
          License Agreement, the terms of which are incorporated into, and
          considered part of, this Agreement. Hoffman’s End User Terms of Use
          License Agreement can be found at www.Hoffman.com.
        </p>
      </>
    ),
  },

  {
    ...
    content: (
      <>
        <p className="font-light mb-4">
          Although Hoffman cannot guarantee user safety, Hoffman seeks to be
          ...
          description of your concerns to support@Hoffman.com.
        </p>
        <p className="font-light mb-4">
          ...
          older. Hoffman also strongly recommends that children ages 13 through
          17 consult their parents or legal guardians before using the Site. If
          you believe a child under the age of 13 is using the Site, please send
          all pertinent information to support@Hoffman.com.
        </p>
      </>
    ),
  },
    ...
    content: (
      <>
        <p className="font-light mb-4">
          ...
          account login information. You agree to notify Hoffman immediately of
          all unauthorized use of your account and if the security or secrecy of
          your account login information has been compromised. You may be held
          responsible for any losses incurred by Hoffman or any other user of
          the Site that are in any way related to your failure to maintain the
    ...
    content: (
      <>
        <p className="font-light mb-4">
          ...
          herein, Hoffman does not grant any express or implied rights to use
          ...
          or completeness by us. Hoffman offers no guarantees and assumes no
          ...
          between the Third Party Content and the Content offered by Hoffman.
          You agree that you will not hold Hoffman responsible or liable with
        ...
        <p className="font-light mb-4">
          ...
          services and resources, you acknowledge that: (1) Hoffman is not
          ...
          Hoffman is not responsible for any other form of transmission received
          from any linked site. Hoffman provides these links to you only as a
          convenience, and the inclusion of any link does not imply our approval
          or endorsement. Any issues or concerns regarding any such site should
          be directed to the owner or operator of that site.
        </p>
        <p className="font-light mb-4">
          “Hoffman” and other Hoffman graphics, logos, designs, page headers,
          button icons, scripts and Site names are trademarks in the United
          States and other countries. Our trademarks and trade dress, as well as
          third party trademarks, logos and Site marks contained on the Site,
          may not be used in connection with any product or Site in any manner
          that is likely to cause confusion and may not be copied, imitated, or
          used, in whole or in part, without the prior written permission of
          Hoffman or such third party that may own the mark.
        </p>
      </>
    ),
  },
    ...
    content: (
      <>
        ...
        <ul className="list-disc font-light ml-10 my-3">
          ...
          <li>
            Hoffman’s designated agent to receive and act on copyright
            ...
            Copyright Act (DMCA) may be contacted at: accounts@Hoffman.com or
            Hoffman, Attn: Copyright Claims, 604 arizona ave, Santa Monica,
        ...
        <p className="font-light mb-4">
          In accordance with the DMCA, Hoffman has adopted a policy of
...

  {
    ...
    content: (
      <>
        ...
        <ul className="list-disc font-light ml-10 my-3">
          <li>
            Both you and Hoffman acknowledge that the Terms are concluded
            between you and Hoffman only, and not with Apple, and that Apple is
            not responsible for the Application or any content therein;
          </li>
          ...
          <li>
            You acknowledge and agree that Hoffman, and not Apple, is
            responsible
          </li>
          ...
          <li>
            ...
            intellectual property rights, Hoffman, and not Apple, will be
          ...
          <li>
            Both you and Hoffman acknowledge and agree that, in your use of the
          </li>

          <li>
            Both you and Hoffman acknowledge and agree that Apple and Apple’s
...

  {
    ...
    content: (
      <>
        <p className="font-light mb-4">
          You agree to defend, indemnify and hold harmless Hoffman, its
...

  {
    ...
    content: (
      <>
        <p className="font-light mb-4">
          Except where prohibited by law, in no event will Hoffman its officers,
          shareholders, predecessors, successors in interest, directors,
          employees, agents, subsidiaries, affiliates, licensors and suppliers
          be liable for any indirect, special, punitive, incidental, exemplary
          or consequential damages that result from: (1) the use of, or
          inability to use, the Site; (2) the performance of the Site; or (3)
          the conduct of other users of the Site, even if Hoffman has been
          ...
          Hoffman for dissatisfaction with the Site is to stop using the Site.
          If, notwithstanding the terms herein, Hoffman is found liable to you
          for any damage or loss which arises out of or is in any way connected
          with your use of the Site, Hoffman’s liability shall in no event
          exceed $100 US Dollars. In addition to the foregoing limitations of
          liability, you agree that you will not join any claim against Hoffman
          with the claim of any other person or entity in a lawsuit, arbitration
          or other proceeding; that no claim you have against Hoffman shall be
          resolved on a classwide basis; and that you will not assert a claim in
          a representative capacity against Hoffman on behalf of anyone else.
        </p>
      </>
    ),
  },
    ...
    content: (
      <>
        ...
        <p className="font-light mb-4">
          ...
          accept” agreement that Hoffman incorporates into or as a condition of
          downloading software. Except as expressly provided herein, this
    ...
    content: (
      <>
        ...
        <p className="font-light mb-4">
          ...
          Agreement shall be in writing. Notices to Hoffman shall be sent by
          ...
          written verification of receipt) to: Hoffman, Inc., 604 Arizona ave,
          ...
          Hoffman electronically. Notices sent to you shall be sent by personal
          delivery, electronic mail, registered or certified mail (return
          receipt requested, postage prepaid) or commercial express courier
          (with written verification of receipt) to the address listed on your
          account. All notices will be deemed given: (i) when delivered
          personally; (ii) 24 hours after electronic mail is sent, unless
          Hoffman is notified that the email address is invalid; (iii) five (5)
          days after having been sent by registered or certified mail, (or ten
          (10) days for international mail; or (iv) one (1) day after deposit
          with a commercial express courier specifying next day delivery (or two
          (2) days for international courier packages specifying 2-day
    ...
    content: (
      <>
        <p className="font-light mb-4">
          ...
          affecting Hoffman’s intellectual property rights in the Site may cause
          irreparable injury to Hoffman for which monetary damages would not be
          an adequate remedy and Hoffman shall be entitled to equitable relief
          (without a requirement to post a bond) in addition to any remedies it
...
export const FAQItemList: FAQItem[] = [
  {
    title: 'What is Hoffman?',
    content: (
      <>
        <p className="font-light mb-4">
          Hoffman is a HIPAA-secure communications platform for the medical
          ...
          communicate in real life. Hoffman is cross-platform and works across
  ...
  {
    title: 'How can Hoffman make my medical business more efficient?',
    content: (
      <>
        <p className="font-light mb-4">
        ...
        <p className="font-light mb-4">
          When you first log in to Hoffman, you will be asked to create Spaces
  ...
  {
    title: 'How much does Hoffman cost to use?',
    content: (
      <>
        <p className="font-light mb-4">Hoffman is currently free to use.</p>
      </>
    ),
  },

  {
    title: 'Is Hoffman secure?',
    content: (
      <>
        <p className="font-light mb-4">
          Hoffman communications are encrypted and are HIPAA compliant.
        </p>
      </>
    ),
  },
  ...
  {
    title: 'Can I use Hoffman on my mobile phone?',
    content: (
      <>
        <p className="font-light mb-4">
          Hoffman is accessible for all doctors, staff, and patients on mobile.
          Doctors and staff can access Hoffman on every platform, while patients
          are only able to access Hoffman through the application on Android or
          iOS. The Hoffman application will be available for medical
          professionals soon.
        </p>
      </>
    ),
  ...
  {
    title: 'Do I need to be a physician to sign up for Hoffman?',
    content: (
      <>
        <p className="font-light mb-4">
          To sign up for Hoffman, you must have an NPI number or be invited by a
          member with NPI number to ensure HIPAA compliance and security.
        </p>
...
export const HeroItemList: IHero[] = [
  {
    title: ' for offices',
    content:
      ' Message colleagues and patients in real-time. Hoffman has everything you need to get your office up and running in no time! Hoffman enables medical offices and pharma to communicate efficiently with each other.',
  },
  {
    title: ' for PARTNERS',
    content:
      'Be a valued Medical Office Partner. Message Medical offices and physicians in real time. Hoffman enables pharma, medical device companies to communicate efficiently with medical offices and physicians',
  },
];
