  ...
  return (
    <div className="w-full bg-muted relative mx-auto">
      ...
      <div className="text-justify text-text-title justify-center items-center max-w-4xl mx-auto container mt-8">
        ...
        <h2 className="text-2xl font-semibold my-3">USE OF THE SITE</h2>
        <p className="font-light mb-4">
        ...
        <h2 className="text-2xl font-semibold my-3">ACCOUNT SECURITY</h2>
        <p className="font-light mb-4">
        ...
        <h2 className="text-2xl font-semibold my-3">INTELLECTUAL PROPERTY</h2>
        <p className="font-light mb-4">
        ...
        <h2 className="text-2xl font-semibold my-3">APPLE, INC. APP STORE</h2>
        <p className="font-light mb-4">
        ...
        <h2 className="text-2xl font-semibold my-3">INDEMNIFICATION</h2>
        <p className="font-light mb-4">
        ...
        <h2 className="text-2xl font-semibold my-3">DISCLAIMER</h2>
        <p className="font-light mb-4">
        ...
        <h2 className="text-2xl font-semibold my-3">WAIVER</h2>
        <p className="font-light mb-4">
        ...
        <h2 className="text-2xl font-semibold my-3">NOTICE</h2>
        <p className="font-light mb-4">
        ...
        <h2 className="text-2xl font-semibold my-3">EQUITABLE RELIEF</h2>
        <p className="font-light mb-4">
